          ...
          <div className="space-y-3">
            ...
            <div className="footer-social-row flex flex-wrap items-center gap-2.5 pt-2">
              <Button
                ...
                className="!border-[#0866fe] !text-[#0866fe] hover:bg-[#0866fe]/10 h-8 px-3 text-xs font-semibold cursor-pointer transition-all duration-200 hover:scale-105 rounded-lg inline-flex items-center gap-1.5"
                aria-label="Facebook Page"
              >
                <svg className="size-3.5 fill-current flex-shrink-0" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <Button
                ...
                className="!border-[#e1306c] !text-[#e1306c] hover:bg-[#e1306c]/10 h-8 px-3 text-xs font-semibold cursor-pointer transition-all duration-200 hover:scale-105 rounded-lg inline-flex items-center gap-1.5"
              ...
              <Button
                ...
                className="!border-[#0a66c2] !text-[#0a66c2] hover:bg-[#0a66c2]/10 h-8 px-3 text-xs font-semibold cursor-pointer transition-all duration-200 hover:scale-105 rounded-lg inline-flex items-center gap-1.5"
