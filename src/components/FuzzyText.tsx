...
export const FuzzyText: React.FC<FuzzyTextProps> = ({
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      const computedFontFamily =
        fontFamily === 'inherit' ? window.getComputedStyle(canvas).fontFamily || 'monospace, sans-serif' : fontFamily;
  ...
  return (
    <canvas 
      ref={canvasRef} 
      className={`block mx-auto cursor-pointer max-w-full ${className}`} 
