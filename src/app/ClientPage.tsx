              ...
              {marqueeLogos.map((logo, idx) => (
                <div className="brand-ticker-item" key={idx}>
                  ...
                  <img
                    ...
                    width={140}
                    height={50}
                    className="w-auto h-10 max-w-[140px] object-contain"
                  />
                </div>
              ))}
            </div>
              ...
              <div className="mt-8 pt-6 border-t border-white/[0.08]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  <Button
                    ...
                    className="!border-[#1877F2]/60 !text-[#1877F2] hover:!border-[#1877F2] hover:bg-[#1877F2]/15 h-11 w-full cursor-pointer transition-all duration-300 hover:scale-[1.02] rounded-xl"
                  ...
                  >
                    ...
                    <span className="flex flex-1 justify-center font-bold text-white">Facebook</span>
                  </Button>
                  ...
                  <Button
                    ...
                    className="!border-[#0A66C2]/60 !text-[#0A66C2] hover:!border-[#0A66C2] hover:bg-[#0A66C2]/15 h-11 w-full cursor-pointer transition-all duration-300 hover:scale-[1.02] rounded-xl"
                  ...
                  >
                    ...
                    <span className="flex flex-1 justify-center font-bold text-white">LinkedIn</span>
                  </Button>
                  ...
                  <Button
                    ...
                    className="!border-[#E1306C]/60 !text-[#E1306C] hover:!border-[#E1306C] hover:bg-[#E1306C]/15 h-11 w-full cursor-pointer transition-all duration-300 hover:scale-[1.02] rounded-xl"
                    aria-label="Instagram Account"
                  >
                    <svg className="size-5 fill-[#E1306C]" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <span className="flex flex-1 justify-center font-bold text-white">Instagram</span>
                  </Button>
                </div>
              </div>
            </div>
